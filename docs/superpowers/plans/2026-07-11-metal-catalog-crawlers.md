...
**Goal:** Add four metal-genre catalog crawlers — Prosthetic Records, Peaceville (US store), Season of Mist (US store), and 20 Buck Spin — the first of four batches covering the new US-only, USD-billed Shopify record stores researched for the Store tab.
